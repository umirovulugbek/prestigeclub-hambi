		...
		<div>
			...
			<div className='flex justify-center  gap-[10px]'>
				<div
					...
					className={`${selectedGender === 'male' ? ' !border-[#0077FF1F] !bg-[#0077FF1F]  ' : err?.gender === true ? ' border-red' : ' border-white bg-[#EBF0F5] dark:border-[#141414] '
				...
				<div
					className={`${err ? '' : ''}  ${selectedGender === 'female' ? ' !border-[#FF662F1F]  !bg-[#FF662F1F] ' : err?.gender === true ? ' border-red' : ' border-white bg-[#EBF0F5] dark:border-[#141414]'
